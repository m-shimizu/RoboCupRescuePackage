 ...
 *
*/
#ifndef _GAZEBO_SkidSteerDrive_PLUGIN_RC2016_HH_
#define _GAZEBO_SkidSteerDrive_PLUGIN_RC2016_HH_
...
namespace gazebo
{
  ...
  class GAZEBO_VISIBLE SkidSteerDrivePlugin : public ModelPlugin
  {
    ...
    /// \brief velocity of liner
    private: double vel_lin; 
    /// \brief velocity of rotation
    private: double vel_rot; 
